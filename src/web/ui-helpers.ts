...
export const SVG_ICONS = {
  ...
  home: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12 12 3l9 9"/><path d="M5 10v10a1 1 0 0 0 1 1h4v-6h4v6h4a1 1 0 0 0 1-1V10"/></svg>`,
  lightbulb: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18h6"/><path d="M10 22h4"/><path d="M12 2a7 7 0 0 0-4 12.7c.8.6 1.3 1.5 1.3 2.5V18h5.4v-.8c0-1 .5-1.9 1.3-2.5A7 7 0 0 0 12 2z"/></svg>`,
...
export function getSplitDisplay(task: Task, schedule?: Schedule | null): SplitDisplay | null {
  ...
  if (schedule) {
    const other = schedule.tasks.find((t) => t.splitGroupId === task.splitGroupId && t.splitPart !== part);
    if (other) {
